...
{
    protected $fillable = [
        'first_name', 'last_name', 'age', 'job_title', 'education_level', 'degree',
        'address', 'phone_primary', 'phone_secondary', 'phone_landline',
        'division_id', 'battalion_id', 'unit_id', 'organization_id',
        'employee_type_id',
        'name',
